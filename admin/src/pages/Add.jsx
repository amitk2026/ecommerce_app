      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
          <div>
              ...
              <div className='flex gap-2'>
                  <label className=' w-25 text-[0px]' htmlFor="image1">
                  ...
                  <label className='w-25 text-[0px]' htmlFor="image2">
                  ...
                  <label className='w-25 text-[0px]' htmlFor="image3">
                  ...
                  <label className='w-25 text-[0px]' htmlFor="image4">
          ...
          <div>
              ...
              <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='40' />
           </div>
